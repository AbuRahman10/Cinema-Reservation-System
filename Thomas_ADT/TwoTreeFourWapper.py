    ...
    def merge(self, pointer):
        ...
        if pointer.parent.type == 2 and pointer.parent.children[0].type == 2 and pointer.parent.children[1].type == 2:
            ...
            while index < 4:
                if pointer.parent.children[index] == pointer:
                    pointer.parent.children[index] = Node(pointer.children[0].keys[0], pointer.children[0].items[0],
                                                          pointer.parent)
                    break
                index += 1
        ...
        # 2. Als de ouder van de om te vormen knoop een 3-knoop is
            ...
            if pointer.parent.children[0].type == 2 and pointer.parent.children[1].type == 2:
                ...
                pointer.parent.children[index].children[0] = Node(pointer.children[0].keys[0],
                                                                  pointer.children[0].items[0],
                                                                  pointer.parent.children[index])
                ...
                pointer.parent.children[index].children[1] = Node(pointer.children[1].keys[0],
                                                                  pointer.children[1].items[0],
                                                                  pointer.parent.children[index])
